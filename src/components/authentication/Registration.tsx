...
export const Registration = () => {
  ...
  return (
    <FadedBGWrapper modalType={appModals.signup} expected="OPEN" enlarge={true}>
      <div
        className={`mx-auto mt-16 relative bg-[#F8F8F8] w-[95%] rounded-xl sm:w-[25rem]  p-5 h-fit`}
      >
        <div className="w-full flex flex-col py-3 items-center gap-y-3">
          ...
          <div className="flex flex-col w-full gap-y-3 mt-2">
            <Buttons
              ...
              py=""
              isLoading={isLoading}
              classNames={`rounded-[8px] self-center font-semibold bg-orange-800 text-xs text-white w-full md:w-1/2 py-3 ${
                canSubmit
            ...
            <Buttons
              ...
              py=""
              isLoading={isLoading}
              classNames="rounded-[8px] self-center w-full  font-semibold bg-blue-600 text-white w-[95%] md:w-1/2 py-2 hover:bg-blue-700 grid place-content-center active:bg-blue-800 transition-colors"
            >
