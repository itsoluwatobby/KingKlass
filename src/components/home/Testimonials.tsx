...
export default function Testimonials() {
  ...
  return (
    <section className='bg-gray-100 px-3 flex flex-col gap-y-2 w-full pt-1 pb-4 min-h-[50vh]'>
      ...
      {/* COMMENTS */}
      <div className='p-3 flex flex-col gap-y-1 bg-gray-100'>
        {
      ...
      <div className='w-full flex items-center justify-between px-3'>
        <p className='flex items-center font-semibold'>
          <span className='text-[#176BEF]'>G</span>
          <span className='text-[#FF3E30]'>o</span>
          <span className='text-[#F7B529]'>o</span>
          <span className='text-[#176BEF]'>g</span>
          <span className='text-[#179C52]'>l</span>
          <span className='text-[#FF3E30]'>e</span>
        </p>

        <div className='flex items-center gap-x-4'>
          <Buttons
            onClick={() => {}}
            pl='' py='' bgColor='bg-white'
  ...
  return (
    <div className='flex flex-col gap-y-3'>
      ...
      <div className='capitalize font-normal text-xs tex-gray-800 flex items-center justify-between'>
        ...
        <span className='font-sans'>{format(date)}</span>
      </div>
    </div>
  )
}