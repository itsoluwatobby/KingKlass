          ...
          <div className="flex-none md:w-[50%] flex flex-col gap-y-4 w-full">
            ...
            <div className="flex flex-col px-3 text-xs">
              ...
              <p>
                ...
                Quibusdam architecto nostrum veniam suscipit deserunt possimus,
                ea ipsam incidunt laboriosam cupiditate, nemo qui eum eos, quasi
                velit veritatis numquam a quod.
              </p>
            </div>
          </div>
        </div>
